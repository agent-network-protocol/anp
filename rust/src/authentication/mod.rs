...
pub use did_wba::{
    ...
    verify_did_key_binding, AuthenticationError, DidDocumentBundle, DidDocumentOptions, DidProfile,
    DidResolutionOptions, ParsedAuthHeader, VM_KEY_AUTH, VM_KEY_E2EE_AGREEMENT,
    VM_KEY_E2EE_SIGNING,
};
